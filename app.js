window.addEventListener("load", function(){
    ...
    class Partical{
        ...
        update(){
            ...
            if(this.y > this.game.height - this.bottomBouncedBoundary && this.bounced < 5){
                this.bounced ++;
                this.speedY *= -0.7;
            }
        }
    ...
    class Anglerl extends Enemy{
        constructor(game){
            super(game); //get the properties which is already exist in parent class
            this.width = 228;
            this.height = 169;
            this.y = Math.random() * (this.game.height * 0.95 - this.height);
            this.image = document.getElementById('anglerl1');
            this.frameX = Math.floor(Math.random() *3);
            this.lives = 5;
            this.score = this.lives;
        }
    ...
    class Angler2 extends Enemy{
        constructor(game){
            ...
            this.height = 165;
            this.y = Math.random() * (this.game.height * 0.95 - this.height);
            this.image = document.getElementById('anglerl2');
        ...
        draw(context){
            ...
            if(this.game.gameOver){
                ...
                if(this.game.score > this.game.winningScore){
                    ...
                    messsage1 = 'You lose!';
                    messsage2 = 'Try again next time!';
                }
                context.font = '70px ' + this.fontFamily;
                context.fillText(messsage1, this.game.width * 0.5, this.game.height * 0.5 -20);
                context.font = '25px ' + this.fontFamily;
                context.fillText(messsage2, this.game.width * 0.5, this.game.height * 0.5 +20);
            }
            //ammo
    ...
    class Game{
        ...
        update(deltaTime){
            ...
            this.particals.forEach(partical => partical.update());
            this.particals = this.particals.filter(partical => !partical.markedForDeletion)
        ...
        draw(context){
            ...
            this.particals.forEach(partical => partical.draw(context));
            this.enemies.forEach(enemy =>{
                enemy.draw(context);
            });
